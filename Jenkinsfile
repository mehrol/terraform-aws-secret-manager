pipeline {
    ...
    parameters {
        ...
        string(name: 'SECRET_NAME', defaultValue: 'tt/dev-db', description: 'Secret Name')
        string(name: 'SECRET_USERNAME', defaultValue: 'karan', description: 'Secret Username')
        password(name: 'SECRET_PASSWORD', defaultValue: 'mypass6', description: 'Secret Password')
    }
